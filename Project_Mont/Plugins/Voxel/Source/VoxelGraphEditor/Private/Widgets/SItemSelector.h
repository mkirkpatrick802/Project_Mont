...
public:
	SLATE_BEGIN_ARGS(SItemSelector)
		...
		, _CategoryRowStyle(&FVoxelEditorStyle::Get().GetWidgetStyle<FTableRowStyle>("ActionMenu.Row"))
		, _SectionRowStyle(&FVoxelEditorStyle::Get().GetWidgetStyle<FTableRowStyle>("ActionMenu.Row"))
		, _ItemRowStyle(&FVoxelEditorStyle::Get().GetWidgetStyle<FTableRowStyle>("ActionMenu.Row"))
