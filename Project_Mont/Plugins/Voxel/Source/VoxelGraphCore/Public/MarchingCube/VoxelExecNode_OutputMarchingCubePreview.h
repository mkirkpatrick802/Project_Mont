...
#include "VoxelExecNode_OutputMarchingCubePreview.generated.h"
...
USTRUCT()
struct VOXELGRAPHCORE_API FVoxelMarchingCubeBrushPreviewMesh
{
	GENERATED_BODY()
...
USTRUCT()
struct VOXELGRAPHCORE_API FVoxelExecNode_OutputMarchingCubePreview : public FVoxelExecNode
{
	GENERATED_BODY()
...
class VOXELGRAPHCORE_API FVoxelExecNodeRuntime_OutputMarchingCubePreview : public TVoxelExecNodeRuntime<FVoxelExecNode_OutputMarchingCubePreview>
{
public:
	using Super::Super;
...
private:
	...
	TWeakObjectPtr<UVoxelMarchingCubeMeshComponent> WeakMeshComponent;
	TWeakObjectPtr<UVoxelMarchingCubeCollisionComponent> WeakCollisionComponent;
};