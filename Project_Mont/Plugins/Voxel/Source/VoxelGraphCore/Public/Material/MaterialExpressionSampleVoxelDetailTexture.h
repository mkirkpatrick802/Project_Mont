...
UCLASS(Abstract)
class VOXELGRAPHCORE_API UMaterialExpressionSampleVoxelDetailTexture : public UMaterialExpression
{
	GENERATED_BODY()
...
#if WITH_EDITOR
	virtual UVoxelDetailTextureBase* GetDetailTexture() const VOXEL_PURE_VIRTUAL({});
...
UCLASS()
class VOXELGRAPHCORE_API UMaterialExpressionSampleVoxelFloatDetailTexture : public UMaterialExpressionSampleVoxelDetailTexture
{
	GENERATED_BODY()
...
#if WITH_EDITOR
	virtual UVoxelDetailTextureBase* GetDetailTexture() const override
	{
...
UCLASS()
class VOXELGRAPHCORE_API UMaterialExpressionSampleVoxelColorDetailTexture : public UMaterialExpressionSampleVoxelDetailTexture
{
	GENERATED_BODY()
...
UCLASS()
class VOXELGRAPHCORE_API UMaterialExpressionSampleVoxelMaterialDetailTexture : public UMaterialExpressionSampleVoxelDetailTexture
{
	GENERATED_BODY()

public:
	UMaterialExpressionSampleVoxelMaterialDetailTexture();

	UPROPERTY(EditAnywhere, Category = "Config")
	TObjectPtr<UVoxelMaterialDetailTexture> DetailTexture;
...
UCLASS()
class VOXELGRAPHCORE_API UMaterialExpressionGetVoxelMaterialId : public UMaterialExpression
{
	GENERATED_BODY()
