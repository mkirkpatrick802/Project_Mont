...
#include "VoxelNode_UFunction.generated.h"
...
struct VOXELGRAPHCORE_API FVoxelNode_UFunction : public FVoxelNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()

public:
	static TSharedRef<FVoxelNode_UFunction> Make(UFunction* InFunction);
