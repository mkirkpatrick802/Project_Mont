...
#include "VoxelNode_MakeRadialPointSpawner.generated.h"

USTRUCT()
struct VOXELGRAPHCORE_API FVoxelRadialPointSpawner : public FVoxelPointSpawner
{
	GENERATED_BODY()
...
struct VOXELGRAPHCORE_API FVoxelNode_MakeRadialPointSpawner : public FVoxelNode
{
	GENERATED_BODY()
