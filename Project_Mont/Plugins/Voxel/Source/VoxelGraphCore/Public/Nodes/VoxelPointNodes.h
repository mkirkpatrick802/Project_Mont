...
struct VOXELGRAPHCORE_API FVoxelNode_GetPoints : public FVoxelNode
{
	GENERATED_BODY()
...
struct VOXELGRAPHCORE_API FVoxelNode_FilterPoints : public FVoxelNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Point")
struct VOXELGRAPHCORE_API FVoxelNode_DensityFilter : public FVoxelNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
