...
#include "VoxelNode_Select.generated.h"

USTRUCT(Category = "Flow Control", meta = (NodeIcon = "Select", NodeIconColor = "White"))
struct VOXELGRAPHCORE_API FVoxelNode_Select : public FVoxelNode
{
	GENERATED_BODY()
