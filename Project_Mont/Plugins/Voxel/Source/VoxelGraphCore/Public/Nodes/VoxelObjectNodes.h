...
struct VOXELGRAPHCORE_API FVoxelNode_IsValidObject : public FVoxelNode
{
	GENERATED_BODY()
...
struct VOXELGRAPHCORE_API FVoxelNode_EqualBase_Object : public FVoxelNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
struct VOXELGRAPHCORE_API FVoxelNode_Equal_Object : public FVoxelNode_EqualBase_Object
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Internal))
struct VOXELGRAPHCORE_API FVoxelNode_NotEqual_Object : public FVoxelNode_EqualBase_Object
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
