...
#include "VoxelTemplateNode_FilterBuffer.generated.h"

USTRUCT(meta = (Internal))
struct VOXELGRAPHCORE_API FVoxelNode_FilterBuffer : public FVoxelNode
{
	GENERATED_BODY()
...
struct VOXELGRAPHCORE_API FVoxelTemplateNode_FilterBuffer : public FVoxelTemplateNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
