...
struct VOXELGRAPHCORE_API FVoxelTemplateNode_FloatMathNode : public FVoxelTemplateNode
{
	GENERATED_BODY()
...
struct VOXELGRAPHCORE_API FVoxelNode_Frac : public FVoxelISPCNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
struct VOXELGRAPHCORE_API FVoxelTemplateNode_Frac : public FVoxelTemplateNode_FloatMathNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Internal))
struct VOXELGRAPHCORE_API FVoxelNode_Power : public FVoxelISPCNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Math|Float")
struct VOXELGRAPHCORE_API FVoxelTemplateNode_Power : public FVoxelTemplateNode_FloatMathNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
