...
struct VOXELGRAPHCORE_API FVoxelNode_MixSeeds : public FVoxelISPCNode
{
	GENERATED_BODY()
...
struct VOXELGRAPHCORE_API FVoxelNode_MakeSeeds : public FVoxelNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
struct VOXELGRAPHCORE_API FVoxelNode_PerlinNoise2D : public FVoxelISPCNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Noise")
struct VOXELGRAPHCORE_API FVoxelNode_PerlinNoise3D : public FVoxelISPCNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Noise")
struct VOXELGRAPHCORE_API FVoxelNode_CellularNoise2D : public FVoxelISPCNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Noise")
struct VOXELGRAPHCORE_API FVoxelNode_CellularNoise3D : public FVoxelISPCNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Noise")
struct VOXELGRAPHCORE_API FVoxelNode_TrueDistanceCellularNoise2D : public FVoxelISPCNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Noise")
struct VOXELGRAPHCORE_API FVoxelNode_TrueDistanceCellularNoise3D : public FVoxelISPCNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
