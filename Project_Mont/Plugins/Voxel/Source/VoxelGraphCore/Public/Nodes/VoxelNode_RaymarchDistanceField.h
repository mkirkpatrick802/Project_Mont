...
#include "VoxelNode_RaymarchDistanceField.generated.h"
...
public:
	...
	const TSharedRef<const TVoxelComputeValue<FVoxelSurface>> ComputeSurface;
...
struct VOXELGRAPHCORE_API FVoxelNode_RaymarchDistanceField : public FVoxelNode
{
	GENERATED_BODY()
