...
struct VOXELGRAPHCORE_API FVoxelTemplateNode_LerpBase : public FVoxelTemplateNode
{
	GENERATED_BODY()
	...
	VOXEL_INPUT_PIN(bool, Clamp, true);
...
struct FVoxelNode_Lerp : public FVoxelISPCNode
{
	...
	{
		return "{ReturnValue} = lerp({A}, {B}, {Clamp} ? clamp({Alpha}, 0.f, 1.f) : {Alpha})";
	}
};
...
struct VOXELGRAPHCORE_API FVoxelTemplateNode_Lerp : public FVoxelTemplateNode_LerpBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Internal))
struct VOXELGRAPHCORE_API FVoxelTemplateNode_SafeLerp : public FVoxelTemplateNode_LerpBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Internal))
struct VOXELGRAPHCORE_API FVoxelNode_SmoothStep : public FVoxelISPCNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
	...
	virtual FString GenerateCode(FCode& Code) const override
	{
		return "{ReturnValue} = SmoothStep({A}, {B}, {Clamp} ? clamp({Alpha}, 0.f, 1.f) : {Alpha})";
	}
};
...
USTRUCT(Category = "Math|Misc")
struct VOXELGRAPHCORE_API FVoxelTemplateNode_SmoothStep : public FVoxelTemplateNode_LerpBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
