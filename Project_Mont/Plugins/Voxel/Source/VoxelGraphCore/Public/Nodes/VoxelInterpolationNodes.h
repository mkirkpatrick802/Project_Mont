...
struct VOXELGRAPHCORE_API FVoxelNode_Interpolate : public FVoxelISPCNode
{
	GENERATED_BODY()
...
struct VOXELGRAPHCORE_API FVoxelTemplateNode_Interpolate : public FVoxelTemplateNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
