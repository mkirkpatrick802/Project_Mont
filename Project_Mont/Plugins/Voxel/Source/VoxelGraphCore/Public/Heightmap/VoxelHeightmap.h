...
DECLARE_VOXEL_MEMORY_STAT(VOXELGRAPHCORE_API, STAT_VoxelHeightmapMemory, "Voxel Heightmap Memory");
...
class VOXELGRAPHCORE_API FVoxelHeightmap
{
public:
...
public:
	...
	FORCEINLINE float GetHeight(const int32 X, const int32 Y) const
	{
...
USTRUCT()
struct VOXELGRAPHCORE_API FVoxelHeightmapConfig
{
	GENERATED_BODY()
...
class VOXELGRAPHCORE_API UVoxelHeightmap : public UObject
{
	GENERATED_BODY()
...
USTRUCT()
struct VOXELGRAPHCORE_API FVoxelHeightmapRef
{
	GENERATED_BODY()
...
USTRUCT()
struct VOXELGRAPHCORE_API FVoxelHeightmapRefPinType : public FVoxelObjectPinType
{
	GENERATED_BODY()
