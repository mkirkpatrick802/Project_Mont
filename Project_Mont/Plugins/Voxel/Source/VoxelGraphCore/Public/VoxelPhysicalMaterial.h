...
struct VOXELGRAPHCORE_API FVoxelPhysicalMaterial
{
	GENERATED_BODY()
...
USTRUCT()
struct VOXELGRAPHCORE_API FVoxelPhysicalMaterialPinType : public FVoxelObjectPinType
{
	GENERATED_BODY()
...
struct VOXELGRAPHCORE_API FVoxelPhysicalMaterialBuffer final : public FVoxelSimpleTerminalBuffer
{
	GENERATED_BODY()
