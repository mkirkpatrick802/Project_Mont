...
USTRUCT()
struct VOXELGRAPHCORE_API FVoxelScreenSizeChunkSpawner : public FVoxelChunkSpawner
{
	GENERATED_BODY()
...
struct VOXELGRAPHCORE_API FVoxelNode_MakeScreenSizeChunkSpawner : public FVoxelNode
{
	GENERATED_BODY()
