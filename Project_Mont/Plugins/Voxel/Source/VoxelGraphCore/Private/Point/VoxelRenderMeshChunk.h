...
struct FVoxelInstancedMeshComponentSettings;
...
private:
	...
	TVoxelMap<FVoxelPointId, int32> PointIdToIndex_RequiresLock;
	...
	struct FComponents
	{
		TVoxelMap<FVoxelPointId, FIndexInfo> PointIdToIndexInfo;
