...
struct VOXELGRAPHCORE_API FVoxelTransformRefNode
{
...
class VOXELGRAPHCORE_API FVoxelTransformRefNodeArray
{
public:
...
class VOXELGRAPHCORE_API FVoxelTransformRefImpl : public TSharedFromThis<FVoxelTransformRefImpl>
{
public:
	const FName Name;
