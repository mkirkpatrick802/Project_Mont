...
#include "Material/MaterialExpressionSampleVoxelDetailTexture.h"
...
#if WITH_EDITOR
int32 UMaterialExpressionSampleVoxelDetailTexture::Compile(FMaterialCompiler* Compiler, const int32 OutputIndex)
{
	const UVoxelDetailTextureBase* DetailTexture = GetDetailTexture();
	if (!DetailTexture)
	{
...
void UMaterialExpressionSampleVoxelDetailTexture::GetCaption(TArray<FString>& OutCaptions) const
{
	...
	if (const UVoxelDetailTextureBase* DetailTexture = GetDetailTexture())
	{
...
UMaterialExpressionSampleVoxelMaterialDetailTexture::UMaterialExpressionSampleVoxelMaterialDetailTexture()
{
...
#if WITH_EDITOR
void UMaterialExpressionSampleVoxelMaterialDetailTexture::SetupCustomExpression(UMaterialExpressionCustom& Custom) const
{
...
int32 UMaterialExpressionSampleVoxelMaterialDetailTexture::Compile(FMaterialCompiler* Compiler, const int32 OutputIndex)
{
