...
class FVoxelLandscapeHeightSceneProxy : public FPrimitiveSceneProxy
{
public:
	explicit FVoxelLandscapeHeightSceneProxy(const UVoxelLandscapeHeightComponent& Component);
...
private:
	...
	const TSharedRef<FVoxelLandscapeHeightMesh> Mesh;
